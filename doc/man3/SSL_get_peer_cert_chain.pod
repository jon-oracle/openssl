...
not successful (as indicated by L<SSL_get_verify_result()|SSL_get_verify_result(3)> not returning
...
is returned by these functions. Applications can call L<SSL_session_reused()|SSL_session_reused(3)>
