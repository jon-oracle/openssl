...
utility function L<SSL_CONF_cmd_argv()|SSL_CONF_cmd_argv(3)> is normally used instead. One way
to do this is to set the prefix to an appropriate value using
L<SSL_CONF_CTX_set1_prefix()|SSL_CONF_CTX_set1_prefix(3)>, pass the current argument to B<option> and the
