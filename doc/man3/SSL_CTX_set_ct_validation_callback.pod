...
See L<SSL_set_verify(3)>, <L<SSL_get_verify_result()|SSL_get_verify_result(3)>3)>, L<SSL_session_reused(3)>.
...
The time returned by L<SSL_SESSION_get_time()|SSL_SESSION_get_time(3)> will be used to evaluate whether any
