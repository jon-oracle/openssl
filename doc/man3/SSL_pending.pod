...
return 1, and then a subsequent call to SSL_read_ex() or L<SSL_read()|SSL_read(3)> to return no
...
SSL_read_ex() or L<SSL_read()|SSL_read(3)> call because the buffered and unprocessed data is
